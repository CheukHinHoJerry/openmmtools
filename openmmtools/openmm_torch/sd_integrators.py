...
class CustomLangevinIntegrator(openmmtools.integrators.ThermostatedIntegrator):
    ...
    def __init__(self,
        ...
        super(CustomLangevinIntegrator, self).__init__(temperature, timestep)
    ...
    def _add_O_step(self):
        ...
        # update velocities
        self.addComputePerDof("v", "(a * v) + (b * sigma * g1)")
        self.addConstrainVelocities()
